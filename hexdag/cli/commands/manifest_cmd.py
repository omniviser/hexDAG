...
app = typer.Typer(help="Manifest file management commands")
console = Console()


# ...existing code...
# The TOML-based manifest CLI implementation is the canonical version.
# Remove the old YAML-based code and keep TOML-based functions:
# - validate_manifest
# - build_manifest
# - diff_manifests
