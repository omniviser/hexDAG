...
Configure logging globally::
    ...
    from hexdag.kernel.logging import configure_logging
...
if TYPE_CHECKING:
    ...
    from hexdag.kernel.types import Logger
...
def get_logger(name: str) -> "Logger":
    ...
    Examples
    --------
    >>> from hexdag.kernel.logging import get_logger, set_correlation_id
    ...
    - Logger names follow the module hierarchy (e.g., "hexdag.kernel.orchestrator")
...
def enable_stdlib_logging_bridge() -> None:
    ...
    Examples
    --------
    >>> from hexdag.kernel.logging import configure_logging, enable_stdlib_logging_bridge
...
def set_correlation_id(cid: str) -> None:
    ...
    Examples
    --------
    >>> from hexdag.kernel.logging import set_correlation_id, get_logger
...
def get_correlation_id() -> str:
    ...
    Examples
    --------
    >>> from hexdag.kernel.logging import get_correlation_id, set_correlation_id
    >>> get_correlation_id()
    '-'
    >>> set_correlation_id('req-abc-123')
    >>> get_correlation_id()
...
def clear_correlation_id() -> None:
    ...
    Examples
    --------
    >>> from hexdag.kernel.logging import clear_correlation_id
