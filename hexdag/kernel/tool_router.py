    ...
    **kwargs : Any
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize the router, resolving any string tool references to callables."""
...
class ToolRouterCall(PortCallEvent):
    """Event emitted for every tool call dispatched by ToolRouter.
...
ToolRouterPortCall = ToolRouterCall
"""Backward-compat alias for :class:`ToolRouterCall`."""

ToolRouterEvent = ToolRouterCall
"""Deprecated alias for :class:`ToolRouterCall`."""
