...
```python
from hexdag.stdlib.events import ObserverManager, NodeStarted
...
```python
from hexdag.stdlib.events import (
...
uv run pytest tests/hexdag/kernel/application/events/ -v
...
- [Test Examples](../../../../../tests/hexdag/kernel/application/events/) - Comprehensive test suite
- [Performance Tests](../../../../../tests/hexdag/kernel/application/events/test_performance.py) - Benchmark validations
