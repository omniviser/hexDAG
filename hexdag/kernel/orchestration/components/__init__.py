...
_DEPRECATED_MAPPING: dict[str, tuple[str, str, str]] = {
    "PolicyCoordinator": (
        "hexdag.kernel.orchestration.components.policy_coordinator",
        "PolicyCoordinator",
        "ExecutionCoordinator",
    ),
    "InputMapper": (
        "hexdag.kernel.orchestration.components.input_mapper",
        "InputMapper",
        "ExecutionCoordinator",
    ),
    "HealthCheckManager": (
        "hexdag.kernel.orchestration.components.health_check_manager",
        "HealthCheckManager",
        "LifecycleManager",
    ),
    "SecretManager": (
        "hexdag.kernel.orchestration.components.secret_manager",
        "SecretManager",
        "LifecycleManager",
    ),
    "AdapterLifecycleManager": (
        "hexdag.kernel.orchestration.components.adapter_lifecycle_manager",
        "AdapterLifecycleManager",
        "LifecycleManager",
    ),
}
