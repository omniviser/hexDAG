...
from hexai.app.application.prompt.template import ChatPromptTemplate
...
class PipelineBuilderError(Exception):
    """Custom exception for pipeline building errors."""
...
class PipelineBuilder:
    ...
    def build_from_yaml_file(self, yaml_file_path: str) -> tuple[DirectedGraph, dict[str, Any]]:
        ...
        try:
            ...
            raise PipelineBuilderError(f"Failed to load YAML file '{yaml_file_path}': {e}") from e
    ...
    def build_from_yaml_string(self, yaml_content: str) -> tuple[DirectedGraph, dict[str, Any]]:
        ...
        try:
            ...
            raise PipelineBuilderError(f"Invalid YAML content: {e}") from e
