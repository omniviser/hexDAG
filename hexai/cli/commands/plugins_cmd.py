...
def _get_available_plugins() -> list[dict[str, Any]]:
    ...
    known_extras = {
        "openai": {
            "module": "hexai.adapters.openai",
            "capabilities": ["LLM", "Embeddings"],
        },
        "anthropic": {
            "module": "hexai.adapters.anthropic",
            "capabilities": ["LLM"],
        },
        "visualization": {
            "module": "hexai.visualization",
...
def _check_dependencies() -> list[dict]:
    ...
    adapter_packages: dict[str, Any] = {
        "openai": {
            "display": "OpenAI",
            "adapter_module": "hexai.adapters.openai",
            "extra": "adapters-openai",
        },
        "anthropic": {
            "display": "Anthropic",
            "adapter_module": "hexai.adapters.anthropic",
