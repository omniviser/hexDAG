...
from hexdag.core.registry.decorators import node
from hexdag.core.registry.exceptions import RegistryAlreadyBootstrappedError, RegistryImmutableError
...
class TestBootstrapArchitecture:
    ...
    def test_bootstrap_from_manifest(self):
        ...
        entries = [
            ManifestEntry(namespace="test", module="tests.hexdag.core.registry.sample_components")
        ]
...
def register_components(registry, namespace):
    ...
    from hexdag.core.registry.discovery import discover_components
    import sys
    ...
    def test_import_error_rollback(self):
        ...
        entries = [ManifestEntry(namespace="core", module="hexdag.core.non_existent_module")]
...
class TestTOMLBootstrap:
    ...
    def test_bootstrap_from_toml(self):
        ...
        config_content = """
modules = [
    "tests.hexdag.core.registry.sample_components",
]
...
"""
    ...
    def test_bootstrap_dev_mode_from_config(self):
        ...
        config_content = """
modules = ["tests.hexdag.core.registry.sample_components"]
dev_mode = true
"""
        with tempfile.NamedTemporaryFile(mode="w", suffix=".toml", delete=False) as f:
            f.write(config_content)
