...
from hexdag.core.config import ConfigLoader, config_to_manifest_entries, load_config
from hexdag.core.config.models import LoggingConfig
...
class TestConfigLoader:
    ...
    def test_load_simple_config(self):
        ...
        config_content = """
modules = ["hexdag.core.nodes", "hexdag.core.adapters"]
...
"""
        ...
        try:
            ...
            assert "hexdag.core.nodes" in config.modules
...
"""
    ...
    def test_environment_variable_substitution(self):
        ...
        os.environ["TEST_MODULE"] = "hexdag.core.test"
...
"""
        ...
        try:
            ...
            assert "hexdag.core.test" in config.modules
        finally:
            Path(config_path).unlink()
...
"""
        ...
        try:
            ...
            assert len(core_modules) == 2  # hexdag.core.nodes and hexdag.core.adapters
