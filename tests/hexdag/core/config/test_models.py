...
class TestManifestEntry:
    ...
    def test_valid_entry(self) -> None:
        ...
        entry = ManifestEntry(namespace="core", module="hexdag.builtin.nodes")
        assert entry.namespace == "core"
        assert entry.module == "hexdag.builtin.nodes"

    def test_empty_namespace_raises_error(self) -> None:
        """Test that empty namespace raises ValidationError."""
        with pytest.raises(ValidationError) as exc_info:
            ManifestEntry(namespace="", module="hexdag.builtin.nodes")
    ...
    def test_namespace_with_colon_raises_error(self) -> None:
        ...
        with pytest.raises(ValidationError) as exc_info:
            ManifestEntry(namespace="core:test", module="hexdag.builtin.nodes")
        assert "namespace" in str(exc_info.value)
