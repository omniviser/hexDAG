...
from hexdag.core.pipeline_builder.tag_discovery import (
    _get_tag_syntax,
    discover_tags,
    get_known_tag_names,
    get_tag_schema,
...
class TestDiscoverTags:
    ...
    def test_discovers_py_tag(self) -> None:
        ...
        assert "hexdag.core.pipeline_builder.py_tag" in tags["!py"]["module"]
    ...
    def test_discovers_include_tag(self) -> None:
        ...
        assert "hexdag.core.pipeline_builder.include_tag" in tags["!include"]["module"]
