"""Tests for hexdag.cli.main module."""
...
from hexdag.cli.main import app, callback, main
...
class TestMainFunction:
    ...
    def test_main_executable_via_python_m(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "hexdag.cli", "--version"],
            capture_output=True,
            text=True,
            timeout=5,
        )
...
class TestCLIImportError:
    ...
    def test_import_error_handling(self):
        ...
        from hexdag.cli import main as cli_main_module
