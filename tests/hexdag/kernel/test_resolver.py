...
class TestResolve:
    ...
    def test_resolve_legacy_namespace_format(self) -> None:
        """Test resolving using legacy namespace:name format (adapter/macro core: aliases)."""
        # Node core: aliases have been removed (dead code).
        # Adapter/macro core: aliases are still generated by _discovery.py.
        from hexdag.stdlib.macros import ReasoningAgentMacro

        result = resolve("core:reasoning_agent")
