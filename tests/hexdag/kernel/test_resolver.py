...
class TestResolve:
    ...
    def test_resolve_builtin_node_full_path(self) -> None:
        ...
        from hexdag.stdlib.nodes import FunctionNode

        result = resolve("hexdag.stdlib.nodes.FunctionNode")
    ...
    def test_resolve_builtin_adapter_full_path(self) -> None:
        ...
        result = resolve("hexdag.stdlib.adapters.mock.MockLLM")
    ...
    def test_resolve_nonexistent_class_raises_error(self) -> None:
        ...
        with pytest.raises(ResolveError) as exc_info:
            resolve("hexdag.stdlib.nodes.NonExistentClass")
    ...
    def test_resolve_error_shows_available_names(self) -> None:
        ...
        with pytest.raises(ResolveError) as exc_info:
            resolve("hexdag.stdlib.nodes.WrongClassName")
...
class TestResolveFunction:
    ...
    def test_resolve_builtin_tool(self) -> None:
        ...
        from hexdag.kernel.domain.agent_tools import tool_end

        result = resolve_function("hexdag.kernel.domain.agent_tools.tool_end")
...
class TestResolveIntegration:
    ...
    def test_resolve_and_instantiate_node_factory(self) -> None:
        ...
        FunctionNode = resolve("hexdag.stdlib.nodes.FunctionNode")
    ...
    def test_resolve_macro_class(self) -> None:
        ...
        result = resolve("hexdag.stdlib.macros.ReasoningAgentMacro")
...
class TestUserAliases:
    ...
    def test_register_and_resolve_alias(self) -> None:
        ...
        register_alias("my_func", "hexdag.stdlib.nodes.FunctionNode")
    ...
    def test_alias_takes_precedence_over_builtin(self) -> None:
        ...
        from hexdag.stdlib.nodes import LLMNode

        # Override the built-in "function_node" alias
        register_alias("function_node", "hexdag.stdlib.nodes.LLMNode")
        result = resolve("function_node")
        assert result is LLMNode

    def test_unregister_alias(self) -> None:
        """Test unregistering an alias."""
        register_alias("my_alias", "hexdag.stdlib.nodes.FunctionNode")
    ...
    def test_get_registered_aliases(self) -> None:
        ...
        register_alias("alias1", "hexdag.stdlib.nodes.FunctionNode")
        register_alias("alias2", "hexdag.stdlib.nodes.LLMNode")

        aliases = get_registered_aliases()
        assert aliases == {
            "alias1": "hexdag.stdlib.nodes.FunctionNode",
            "alias2": "hexdag.stdlib.nodes.LLMNode",
        }
    ...
    def test_multiple_aliases_same_target(self) -> None:
        ...
        register_alias("fn", "hexdag.stdlib.nodes.FunctionNode")
        register_alias("func", "hexdag.stdlib.nodes.FunctionNode")
        register_alias("function", "hexdag.stdlib.nodes.FunctionNode")
...
spec:
  aliases:
    fn: hexdag.stdlib.nodes.FunctionNode
  nodes:
    - kind: fn
      metadata:
        name: my_node
...
spec:
  aliases:
    fn: hexdag.stdlib.nodes.FunctionNode
    llm: hexdag.stdlib.nodes.LLMNode
  nodes:
    - kind: fn
      metadata:
        name: processor
...
spec:
  nodes:
    - kind: hexdag.stdlib.nodes.FunctionNode
      metadata:
        name: my_node
      spec:
        fn: json.loads
