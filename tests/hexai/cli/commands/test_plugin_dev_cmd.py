"""Tests for hexai.cli.commands.plugin_dev_cmd module."""
...
from hexai.cli.commands.plugin_dev_cmd import app, get_plugin_dir
...
def mock_console():
    ...
    with patch("hexai.cli.commands.plugin_dev_cmd.console") as mock:
        yield mock
...
class TestCreatePlugin:
    ...
    def test_create_plugin_success(self, runner, tmp_path):
        ...
        with patch("hexai.cli.commands.plugin_dev_cmd.get_plugin_dir", return_value=plugin_dir):
...
class TestListPlugins:
    ...
    def test_list_plugins_no_directory(self, runner, tmp_path):
        ...
        with patch(
            "hexai.cli.commands.plugin_dev_cmd.get_plugin_dir",
