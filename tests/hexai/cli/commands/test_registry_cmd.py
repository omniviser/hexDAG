"""Tests for hexai.cli.commands.registry_cmd module."""
...
from hexai.cli.commands.registry_cmd import ComponentFilter, app
...
def mock_registry():
    ...
    with patch("hexai.cli.commands.registry_cmd.registry") as mock:
        yield mock
...
def mock_console():
    ...
    with patch("hexai.cli.commands.registry_cmd.console") as mock:
        yield mock
...
def sample_component():
    ...
    from hexai.core.registry.models import ClassComponent
...
class TestListComponents:
    ...
    def test_list_components_table_format(self, runner, mock_registry, sample_component):
        ...
        with patch("hexai.cli.commands.registry_cmd.bootstrap_registry"):
