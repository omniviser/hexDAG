"""Tests for hexai.cli.commands.init_cmd module."""
...
from hexai.cli.commands.init_cmd import _generate_config, _print_adapter_info, app, init
...
def mock_console():
    ...
    with patch("hexai.cli.commands.init_cmd.console") as mock:
        yield mock
...
class TestInit:
    ...
    def test_init_creates_config_in_current_dir(self, runner, tmp_path):
        ...
        with runner.isolated_filesystem(temp_dir=tmp_path):
            ...
            assert "hexai.core.ports" in content
...
class TestGenerateConfig:
    ...
    def test_generate_config_no_adapters(self):
        ...
        assert "hexai.core.ports" in config
        assert "hexai.adapters.mock" in config
