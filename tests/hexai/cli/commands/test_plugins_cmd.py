"""Tests for hexai.cli.commands.plugins_cmd module."""
...
from hexai.cli.commands.plugins_cmd import (
    OutputFormat,
    _check_dependencies,
...
def mock_console():
    ...
    with patch("hexai.cli.commands.plugins_cmd.console") as mock:
        yield mock
...
def mock_registry():
    ...
    with patch("hexai.cli.commands.plugins_cmd.registry") as mock:
        yield mock
...
class TestListPlugins:
    ...
    def test_list_plugins_table_format(self, runner):
        ...
        with patch("hexai.cli.commands.plugins_cmd._get_available_plugins") as mock_get:
...
class TestCheckPlugins:
    ...
    def test_check_plugins_all_ok(self, runner):
        ...
        with patch("hexai.cli.commands.plugins_cmd._check_dependencies") as mock_check:
...
class TestGetAvailablePlugins:
    ...
    def test_get_available_plugins_returns_list(self):
        ...
        with patch("hexai.cli.commands.plugins_cmd.bootstrap_registry"):
            with patch("hexai.cli.commands.plugins_cmd.registry") as mock_registry:
    ...
    def test_get_available_plugins_with_adapters(self):
        ...
        from hexai.core.registry.models import ComponentInfo, ComponentMetadata, ComponentType
