...
- Reference docs (`reference/nodes.md`, `reference/adapters.md`, `reference/ports.md`, `reference/tools.md`) are auto-generated by the mkdocs hook in `docs/.hooks/registry_docs.py`
- ~~Stale root-level `docs/nodes.md` and `docs/adapters.md`~~ — **Resolved:** deleted in favor of auto-generated `reference/` versions
