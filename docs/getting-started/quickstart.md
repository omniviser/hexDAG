...
```python
from hexai.core.application.events import EventBus, NodeStarted, NodeCompleted
...
- [Node Types](../guide/node-types.md) - Explore LLM, Agent, Loop, and Conditional nodes
- [YAML Pipelines](../guide/yaml-pipelines.md) - Build complex declarative workflows
